...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-12 w-full items-center justify-between rounded-md border border-border bg-background px-4 py-5 text-base text-foreground/70 outline-none placeholder:text-foreground/40 focus:border-accent",
      className
    )}
    {...props}
  >
